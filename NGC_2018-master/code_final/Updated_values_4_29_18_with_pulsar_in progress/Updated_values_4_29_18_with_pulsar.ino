...
void loop() {
  ...
  if (wormhole == true) {
    ...
    if ((r <= 20 && r >= 0) && (g <= 52 && g >= 43) && (b <= 39 && b >= 29) && (c <= 150)) { //green
      planettype = 6;
      //(8,68,42,109)
      //New Values from sunday (16,57,35,106)
    }

    if ((r <= 15 && r >= 0) && (g <= 40 && g >= 25) && (b <= 92 && b >= 75) && (c <= 145)) { //blue
      planettype = 2;
      //(3,35,110,141)
    ...
    if ((r <= 53 && r >= 46) && (g <= 52 && g >= 45) && (b <= 38 && b >= 30) && (c <= 160)) { //yellow
      planettype = 4;
      //(57,68,48,157)
      //new values(49,48,33,123)
    }

    if ((r <= 55 && r >= 43) && (g <= 31 && g >= 25) && (b <= 75  && b >= 68) && (c <= 190)) { //magenta
      planettype = 5;
      //(51,36,111,184)
    ...
    if ((r <= 22  && r >= 5) && (g <= 62 && g >= 53) && (b <= 54  && b >= 43) && (c <= 165)) { //cyan
      planettype = 1;
      //(7,70,66,131)
      //(19,56,49,120)
    }

    if ((r <= 50 && r >= 40) && (g <= 65 && g >= 52) && (b <= 80  && b >= 72) && (c >= 165)) { //pulsar
      planettype = 7;
