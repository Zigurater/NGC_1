...
if ((wormhole == false) and (LswitchR == HIGH) and (LswitchL == HIGH)){
  entered = true;
}else if ((wormhole == true) and (LswitchR == LOW) and (LswitchL == LOW)){
  entered = false;
}

if ((wormhole == false) and (entered == true) and ((apds.readProximity() == 0) or (apds.readProximity() == 1)))  { //entering the wormhole
  wormhole = true;
}else if ((wormhole == true) and (apds.readProximity() > 5)) { //leaving the wormhole
  wormhole = false;
